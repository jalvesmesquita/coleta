                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="" placeholder="Identidade" name="rg" value="{{ $ajudante->rg }}">
                                    @if($errors->has('rg'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">CPF</label>
                                    <input type="text" class="form-control" id="" placeholder="CPF" name="cpf" data-mask="999.999.999.99" value="{{ $ajudante->cpf }}">
                                    @if($errors->has('cpf'))
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" data-mask="(99) 9999-9999" class="form-control" id="" placeholder="Telefone" name="telefone" value="{{ $ajudante->telefone }}">
