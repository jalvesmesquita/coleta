        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form role="form" action="{{ action('ColetaController@update', $coleta->id) }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="" placeholder="Quantidade"
                                           name="quantidade" value="{{ $coleta->quantidade }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="Observacao"
                                           name="observacao" value="{{ $coleta->observacao }}">
